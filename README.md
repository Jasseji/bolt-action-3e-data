...
- nazwy i grupy liczebności pokazują bazowy skład oddziału; dodatkowi żołnierze są opcjami, więc ich liczba nie zastępuje liczebności jednostki w NewRecruit;
